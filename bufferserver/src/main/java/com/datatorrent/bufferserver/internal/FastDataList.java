...
public class FastDataList extends DataList
{
  ...
  public FastDataList(String identifier, int blocksize, int numberOfCacheBlocks, boolean backPressure)
  {
    super(identifier, blocksize, numberOfCacheBlocks, backPressure);
  }
